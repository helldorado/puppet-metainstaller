# Class: metainstalller::apt   -- Original Class name is puppetlabs-apt
#
...
class metainstaller::packagers::apt(
  ...
  $preferences_d  = $metainstaller::packagers::apt::params::preferences_d
  ...
  anchor { 'metainstaller::packagers::apt::update':
