...
class metainstaller::packagers::apt::backports(
  $release  = $::lsbdistcodename,
  $location = $metainstaller::packagers::apt::params::backports_location
) inherits metainstaller::packagers::apt::params {
  ...
  metainstaller::packagers::apt::source { 'backports':
    location   => $location,
